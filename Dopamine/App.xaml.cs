...
namespace Dopamine
{
    public partial class App : PrismApplication
    {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            // when not the first instance: try to show the running instance. Notify first wcf to show window
            ...
            if (isNewInstance)
            {
                ...
                Library.FFmpegDirectory = @"H:\jsProjects\RESUME\WPF-MediaHub\dopamine-windows-slim\Dopamine\bin\Debug\FFmpeg\video";
