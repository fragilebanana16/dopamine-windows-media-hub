...
namespace Dopamine.ViewModels.FullPlayer.Collection
{
    public class CollectionViewModel : BindableBase
    {
        ...
        private void NagivateToPage(SlideDirection direction, CollectionPage page)
        {
            ...
            switch (page)
            {
                case CollectionPage.Home:
                    this.regionManager.RequestNavigate(RegionNames.CollectionRegion, typeof(CollectionHome).FullName);
                    break;
                ...
                case CollectionPage.Folders:
                    ...
                    break;
                case CollectionPage.MovieTheater:
                    this.regionManager.RequestNavigate(RegionNames.CollectionRegion, typeof(MovieTheater).FullName);
                    break;
                default:
                    break;
            }
